...
L’IA redistribue aussi les grandes garnisons éloignées du danger. Un territoire intérieur possédant au moins huit unités au-delà de sa réserve peut envoyer environ 85 % de ce surplus par un convoi traversant plusieurs territoires alliés. Cette capacité logistique dédiée augmente avec l’empire, de deux à cinq convois de redistribution simultanés, sans bloquer les créneaux réservés aux offensives. Les capitales, canons, sites rares et merveilles conservent toujours une réserve supplémentaire.
