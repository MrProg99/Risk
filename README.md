...
En mode **Rejoindre**, le bouton principal apparaît directement sous le code du salon et le choix d’équipe afin de rester visible sans devoir atteindre le bas du lobby. Le code est validé sur six caractères puis normalisé automatiquement en majuscules avant son envoi à Firebase. Si le navigateur restaure un ancien salon, la saisie d’un autre code conserve ce bouton visible et quitte proprement l’ancienne salle; un bouton **Quitter ce salon** permet aussi de libérer manuellement la session mémorisée.
...
Les **signaux entre humains** se préparent avec **G + clic gauche** ou le bouton **Signal (G)** sur la carte. Choisissez **Attaquer ici** sur une position ennemie ou neutre, ou **Défendre ici / Renforts ici** sur une position alliée. Le symbole porte la couleur et le nom de son auteur, apparaît sur la mini-carte et possède une notification cliquable pour recentrer la vue. Un son discret avertit les équipiers, sans remplir le journal général. L’affichage est limité à l’équipe et aux positions visibles; le signal n’étend jamais le brouillard de guerre. Il dure **15 secondes de simulation**, avec **3 secondes entre deux envois** et **3 signaux actifs maximum par auteur** (le suivant remplace le plus ancien). Le bouton n’apparaît que si un autre humain appartient à votre équipe. Les IA ne créent ni ne suivent ces signaux pour le moment.
...
Le profil tactique suit la race choisie, indépendamment de la place dans le lobby : Empire militaire, Technocrates analytiques, Horde agressive et Nomades mobiles. Cela détermine notamment la cadence des décisions, la réserve de garnison, la prudence et la proportion de soldats envoyés. Deux participants de même race utilisent le même profil, avec leurs couleurs, territoires et décisions propres; cette règle s’applique aussi aux cinquième et sixième places et à une faction temporairement reprise par l’IA.

Les musiques `Musique/Music1.mp3` à `Musique/Music8.mp3` démarrent avec la partie et jouent successivement. La playlist recommence après le huitième morceau. Si un navigateur bloque la première tentative, le système réessaie automatiquement à la prochaine interaction du joueur. Son volume baisse brièvement pendant le carillon de fin de recherche afin de conserver une alerte claire.
...
La partie se termine par **domination** dès qu’une seule équipe possède encore des territoires. La simulation est alors définitivement mise en pause et l’écran final indique la victoire ou la défaite du joueur, la durée de la campagne et l’équipe dominante. Si l’équipe humaine perd son dernier territoire avant la fin de la guerre — notamment dans une partie contre plusieurs IA — son bilan de défaite s’ouvre immédiatement; **Voir la carte** permet ensuite d’observer les factions encore en lice et le bouton **Sommaire** reste disponible. Le résultat officiel actualise de nouveau le bilan lorsque la dernière équipe domine la carte.
...
Un territoire contrôlé peut être affecté au **recrutement**, à la **production alimentaire** ou à la **recherche** depuis son panneau latéral. En mode nourriture, il conserve sa contribution passive, cesse de recruter et ajoute une capacité dépendant de son terrain : agriculture 80, plaine 50, industrie/science/centrale 40, mine 30, forteresse/radar/aéroport 25. Une Métropole ajoute 50 et un Grand barrage 20 à la valeur du terrain. Un anneau vert et le marqueur `F` permettent de reconnaître ces territoires sur la carte.

En mode Recherche, le territoire cesse également de recruter mais conserve sa nourriture passive. Un laboratoire standard ajoute **10 %** de vitesse scientifique, une centrale **15 %**, un centre scientifique **25 %** et un Centre spatial **35 %**. Un **Centre scientifique contrôlé fournit déjà +8 % de recherche nationale passive**, quelle que soit son affectation; il apporte donc **33 %** au total lorsqu’il devient lui-même un laboratoire. Le bonus cumulé provenant des affectations est plafonné à **50 %**, tandis que les bonus passifs des sites restent indépendants. Un anneau violet et le marqueur `R` signalent les laboratoires. Lors d’une conquête, l’affectation du territoire revient automatiquement au recrutement.
...
La recherche nationale de l’IA est indépendante de sa boucle militaire : dès qu’une technologie se termine, elle choisit la suivante sans attendre une attaque, un convoi, un rassemblement ou la fin d’un Blackout. L’entretien économique vérifie également nourriture, fermes et laboratoires toutes les quelques secondes dans une cadence séparée; une offensive permanente ne peut donc plus empêcher la Horde de traiter une pénurie. L’investissement scientifique territorial reste volontairement conservateur : aucun laboratoire avant six territoires, un maximum d’un laboratoire entre 6 et 11 territoires, deux entre 12 et 20, puis trois au-delà. Les centres scientifiques, centrales et Centres spatiaux sont prioritaires. Un laboratoire redevient militaire si la nourriture tombe sous 110 %, si le front se rapproche ou lorsque l’arbre technologique est terminé, mais la recherche nationale de base continue toujours.
...
Le panneau latéral demeure consacré aux renseignements du territoire. Survoler une cellule ouvre aussi une infobulle compacte qui suit le pointeur et résume son propriétaire, ses unités, son terrain, sa ressource, son activité et ses principaux avantages stratégiques. Elle se replace automatiquement près des bords, disparaît pendant un glissement et ne révèle jamais un territoire couvert par le brouillard de guerre. Un voisin déjà contrôlé ou appartenant à un équipier peut également être choisi comme destination : le panneau contextuel passe au turquoise, son bouton devient **Envoyer le renfort** et les unités rejoignent la garnison alliée après leur déplacement.
...
Le lobby propose une **Carte actuelle** de **2800 × 1800** unités comprenant normalement **110 à 120 cellules de Voronoï**, ou une **Grande carte** de **3600 × 2300** comprenant **165 à 180 cellules**. Les deux variantes génèrent les ressources, les six sites rares, les obstacles et les positions de départ; la grande version augmente aussi le nombre de lacs et d’aéroports. Quatre géographies sont disponibles : Continent, Sablier, Archipel et **Caldeira**. L’Archipel ajoute des cellules maritimes afin de conserver suffisamment de territoires terrestres sur ses quatre ou six îles. La Caldeira place au centre un cratère continu de cinq cellules infranchissables, ou sept sur la Grande carte, que les armées doivent contourner. Le bouton **Nouvelle carte** conserve la taille et la géographie choisies tandis que **Pause** suspend toute la simulation.
...
La recherche **Champs de mines**, dans l’axe Défense après Réseaux fortifiés, permet de piéger un territoire contrôlé. Une équipe du génie prépare la position pendant **40 secondes**, sans interrompre son recrutement, sa nourriture ni sa recherche. Une faction ne peut mener qu’une préparation à la fois et conserver au maximum **cinq** champs actifs ou en cours.

Le piège reste caché aux adversaires jusqu’à son déclenchement. La première armée terrestre ennemie qui entre perd **15 %** de ses effectifs avant le combat, avec un minimum de **3** et un maximum de **25** pertes, puis le champ est consommé. Les convois alliés et les parachutistes ne le déclenchent pas; une capture par parachutistes détruit toutefois le dispositif. Le propriétaire et ses alliés voient le marqueur défensif grâce à leur vision partagée. Le son `Son/MineExplosion.mp3` avertit les membres de l’équipe qui attaque le champ ou qui défend la position minée, sans révéler l’explosion aux autres joueurs.

L’IA recherche, prépare et exploite aussi ces défenses. Elle privilégie les passages étroits, capitales, merveilles, installations et positions déjà menacées, puis évite de gaspiller sa limite sur des villes arrière sans valeur immédiate. La préparation, l’état armé et le déclenchement sont inclus dans les instantanés Firebase; les règles de base de données ne changent pas.
...
Le lobby propose quatre géographies. **Continent** conserve des fronts ouverts et plusieurs itinéraires. **Sablier** place les équipes dans deux grandes moitiés opposées et bloque les autres traversées par une chaîne montagneuse, en conservant un passage central marqué par le symbole `⌛`. **Archipel** forme quatre îles sur la Carte actuelle ou six sur la Grande carte. Les îles sont séparées par des zones maritimes infranchissables et reliées par un réseau de chaussées signalées par `≋`; chaque île possède au moins deux directions stratégiques vers le reste du réseau. **Caldeira** organise les fronts autour d’un volcan central et expose sa ceinture intérieure aux éruptions périodiques. Les montagnes ne peuvent jamais fermer une chaussée ni couper l’intérieur d’une île. La géographie et la taille sont stockées dans le salon Firebase afin que tous les clients reconstruisent la même carte.

Sur une carte Archipel, les factions sont réparties sur des îles différentes lorsque leur nombre le permet. Dans une partie à deux équipes, les alliés occupent la même rangée d’îles et affrontent l’équipe située sur la rangée opposée. Les aéroports, missiles, parachutistes et armes de merveille conservent leur portée au-dessus de l’eau, tandis que les armées et convois terrestres doivent emprunter les passages.

Avant d'obtenir sa première tête de pont sur une carte Archipel, l'IA concentre son expansion sur un seul itinéraire qui réduit réellement la distance vers une liaison interinsulaire. Elle rassemble les garnisons arrière sûres lorsque le prochain territoire résiste, au lieu de disperser ses forces dans des conquêtes latérales. Dès qu'un territoire de la seconde île est contrôlé, elle peut de nouveau ouvrir deux axes d'expansion en parallèle.
...
Avant une offensive ou un transfert ponctuel, l’IA réserve les soldats nécessaires contre les armées ennemies déjà en approche du territoire source. Elle additionne leur puissance, tient compte des bonus défensifs locaux et conserve une marge couvrant les jets de combat. Cette réserve s’applique aussi aux rassemblements, aux redistributions et aux dons de renforts alliés. Les renforts amis attendus ne sont pas considérés comme déjà arrivés; une fois la menace passée, le surplus redevient disponible.

L’IA redistribue aussi les grandes garnisons éloignées du danger. Un balayage logistique indépendant de ses décisions tactiques s’exécute toutes les **9 à 13,5 secondes** et peut vider de deux à quatre villes distinctes au même passage. Un territoire intérieur possédant au moins huit unités au-delà de sa réserve envoie environ 85 % de ce surplus par un convoi, y compris lorsqu’il se trouve juste derrière le front ou que le trajet traverse le territoire d’un équipier. Cette capacité augmente avec l’empire, de trois à dix convois de redistribution simultanés, sans bloquer les créneaux réservés aux offensives. Les capitales, canons, sites rares et merveilles conservent toujours une réserve supplémentaire.

Pendant l’attente d’un rassemblement offensif, l’IA continue à gérer les autres fronts : redistributions, flux continus et renforts ponctuels. Cette logistique ne prélève pas les troupes du point de rassemblement ni de ses donateurs et ne redirige pas leurs lignes encore valides. Le plan reste unique et reprend lorsque les forces et un créneau tactique sont disponibles. Une décision qui envoie effectivement un ordre termine toujours cette étape de réflexion; une simple attente laisse passer les autres décisions.
...
Son réseau de flux continus peut compter jusqu’à **dix-huit villes sources**. Chaque ville intérieure affectée au recrutement établit progressivement sa propre ligne vers l’une des trois frontières les plus urgentes. Lorsqu’une ligne IA est ouverte ou redirigée, elle expédie immédiatement 80 % du stock disponible au-delà de sa réserve; les nouvelles recrues suivent ensuite en continu. Les destinations sont réparties pour éviter un seul point congestionné. Une ligne est automatiquement arrêtée si sa source passe en mode nourriture ou devient elle-même frontalière, puis peut être recréée ailleurs lorsque la situation évolue.
...
L’IA exclut ces frontières bloquées de ses évaluations de menace terrestre : renforts ponctuels, mobilisation, réserves des donateurs alliés et choix alimentaires ou agricoles. Elle compte également uniquement les voisins accessibles pour les raccordements ferroviaires et le soutien terrestre d’une offensive. Les montagnes ne suppriment pas la menace d’une armée déjà en approche et ne modifient pas la portée des armes capables de les franchir.
...
Les territoires de type **Plaine** utilisent la texture `Image/grass.jpg`. Le rendu la désature et la mélange légèrement à la couleur du propriétaire : le relief demeure visible sans remplacer l’identification des factions. Le motif est préparé une seule fois, répété en miroir et n’est pas affiché sous le brouillard de guerre.
...
Le bouton **Recherche** ouvre un arbre de trente technologies réparties sur quatre axes : **Construction**, **Attaque**, **Défense** et **Capacités**. Une faction ne peut étudier qu’une technologie à la fois et doit débloquer les paliers progressifs dans l’ordre. Chaque axe se termine désormais par une recherche ultime de merveille, et l’axe Attaque propose deux projets concurrents. **Bombardier lourd** partage le quatrième palier avec Guerre combinée : c’est une spécialisation facultative qui n’est pas requise pour atteindre les merveilles. **Champs de mines** partage le troisième palier défensif et n’est pas requis pour atteindre la Citadelle. Les Parachutistes exigent la Mobilisation d’urgence, tandis que l’Arme nucléaire et le Blackout exigent d’abord le Missile tactique. Les recherches durent de 1 min 30 à 7 min 30 de temps simulé et continuent pendant les combats. Un carillon à quatre notes avertit le joueur lorsque sa propre recherche est terminée; les recherches des factions contrôlées par l’ordinateur restent silencieuses.

Les bonus débloqués améliorent réellement la production, la puissance de combat, la vitesse des armées, la cadence des canons ou la puissance des aéroports. Les centres scientifiques, les centrales et le Centre spatial accélèrent légèrement la progression; les Technocrates tirent davantage profit de ces territoires. Toutes les factions contrôlées par l’ordinateur choisissent également leurs recherches, en privilégiant une branche adaptée à leur style. Une IA qui contrôle un aéroport accorde une priorité supplémentaire à Bombardier lourd.
...
La **Mobilisation d’urgence** demande trois minutes trente de recherche. Elle ajoute immédiatement 35 unités sur un territoire appartenant au joueur ou à l’un de ses alliés, puis se recharge pendant deux minutes trente. Les unités deviennent la garnison du propriétaire du territoire ciblé et consomment donc sa nourriture; l’interface avertit le joueur lorsque cette mobilisation risque de provoquer une pénurie chez le destinataire.
...
Chaque faction possède ses propres recharges. L’IA recherche et utilise les quatre capacités : elle réserve les mobilisations aux fronts menacés, y compris une capitale ou une position critique appartenant à un allié, largue ses parachutistes sur les positions visibles qu’ils peuvent raisonnablement vaincre, cible avec ses missiles les grandes concentrations et ne déclenche une frappe nucléaire que si les pertes ennemies prévues justifient les dommages collatéraux alliés. Les ordres passent par la commande sérialisable `USE_ABILITY`; les largages en vol, les frappes en attente, leurs animations et les recharges sont inclus dans les instantanés Firebase.
...
Le **Blackout** demande quatre minutes trente de recherche après le Missile tactique. Il cible un territoire ennemi visible puis brouille toute l’équipe correspondante pendant **18 secondes** : ses membres perdent la vision des territoires ennemis et ne peuvent plus lancer d’attaque terrestre, de missile, de largage, de frappe nucléaire ou de Blackout. Leurs canons, aéroports et Grosses Bertha suspendent également leurs tirs, mais les armées déjà parties poursuivent leur mission et les convois alliés restent disponibles. L’équipe retrouve ensuite ses communications et bénéficie de **60 secondes d’immunité**, ce qui empêche plusieurs adversaires d’entretenir un brouillage permanent. La recharge du lanceur est de **cinq minutes**.

L’IA recherche Blackout, le déclenche lorsqu’une offensive crédible est prête et choisit l’équipe possédant la meilleure cible frontalière. Lorsqu’elle est elle-même brouillée, elle cesse de tenter des attaques et consacre ses décisions aux renforts et à la consolidation. L’état du brouillage, son immunité et la recharge sont inclus dans les instantanés Firebase; aucune modification des règles Realtime Database n’est nécessaire.
...
- **Éruption volcanique — Caldeira seulement** : la première survient après 2 min 30 à 3 min 30, puis toutes les 3 à 5 minutes. Une alerte de 12 secondes marque la ceinture du cratère et trois à cinq points d’impact aléatoires. L’éruption détruit 22 à 28 % des garnisons voisines du volcan et chaque roche en fusion retire 10 à 20 % de sa cible, sans éliminer son dernier défenseur. L’IA interrompt les flux dangereux et évacue une partie de ses concentrations avant l’impact.

Le calendrier, les avertissements, les zones d’impact, les effets actifs et les armées barbares sont conservés dans `GameState` et les instantanés Firebase afin que tous les joueurs voient exactement la même catastrophe.
...
L’expansion neutre de l’IA est parallèle et adaptative : une seule décision remplit immédiatement ses axes disponibles. Un petit empire en ouvre jusqu’à deux, un empire établi trois sur la carte actuelle et quatre sur une grande carte. Un simple contact ennemi ne bloque plus cette croissance; la grande carte conserve alors trois axes et la limite ne retombe à deux que si la puissance frontalière adverse dépasse réellement la sienne. L’ouverture Archipel conserve toutefois un seul axe jusqu’au premier débarquement. Après deux recherches sans capacité, chaque profil donne également la priorité à un premier outil stratégique : Missile pour l’Empire et les Technocrates, Mobilisation pour la Horde et les Nomades.
...
`GameState` conserve aussi des index `Map` non sérialisés pour retrouver les territoires, factions et routes de renfort en temps constant. Ces index sont reconstruits automatiquement lorsqu'une nouvelle carte ou un instantané remplace une collection; ils ne modifient donc ni le format des sauvegardes de partie ni les données envoyées à Firebase.
