...
En mode Recherche, le territoire cesse également de recruter mais conserve sa nourriture passive. Un laboratoire standard ajoute **10 %** de vitesse scientifique, une centrale **15 %**, un centre scientifique **25 %** et un Centre spatial **35 %**. Le bonus cumulé provenant de ces affectations est plafonné à **50 %**. Un anneau violet et le marqueur `R` signalent les laboratoires. Lors d’une conquête, l’affectation du territoire revient automatiquement au recrutement.
